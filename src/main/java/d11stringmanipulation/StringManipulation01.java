...
public class StringManipulation01 {
    public static void main(String[] args) {
        ...
        //substring(starting index) ==> returns portion of string by starting from specified index and to the end of
        // string
        ...
        //Example: fetch "is" substring from the given string above....
       ...
       String funnyPart = s.substring(8, 13);
        System.out.println("funnyPart = " + funnyPart);

        //2. way: use single parameter in method parenthesis
       String funnyPart2 = s.substring(8);
       ...
       //Example 6: Check the given string if "is" substring starts with from index 5
        //startWith(a b)
