...
public class IfStatements04 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter a day name I say weekday or weekend!");

        String day = inputDay.next();

        //equals() compares two String and returns true or false
        ...
        if(weekendCondition1 == false && weekdayCondition1 == false){ //!weekendCondition1 && !weekdayCondition1
            System.out.println("Invalid Day Name!");
